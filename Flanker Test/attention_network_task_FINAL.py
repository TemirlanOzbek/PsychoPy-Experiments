...
translations = {
    'English': {
        'welcome': 'Welcome to this experiment.\n\nIn this task, you will be presented with a central arrow surrounded by arrows or blocks. The central arrow will point left or right.\n\nSometimes the flanking arrows will be pointing in the same direction as the central arrow, and sometimes the flanking arrows will point in the opposite direction to the central arrow.\n\neg. >>>>> or >><>>\n\nYour task is to respond to the direction of the central arrow.\n\nIf the central arrow points to the right, press the right arrow key and if the arrow points to the left, press the left arrow key.\n\nPress the space bar to continue.',
        'instructions': 'In this task, you must respond to the direction of the centre arrow using the arrow keys.\n\nFirst, a fixation cross will appear in the centre of the screen. The fixation is sometimes followed by blocks on the screen, which may or may not\ncue the location of the target stimulus. Pay close attention to these cues. They are designed to help you respond faster. If the blocks appear after the fixation, it means that the target will appear shortly. If the blocks appears either above OR below the fixation cross, the target will shortly appear in that cued location.\nPlace your index fingers on the left and right keys ready to start, and press the spacebar to proceed.',
        'reminder': 'Respond to the direction of the central arrow using the left and right keys on your keyboard.',
        'correct': "Correct! Your RT is : ",
        'incorrect': "Incorrect!",
        'no_response': "Remember to respond!",
        'end_message': "You scored {} out of {} correct!\nWasn't that fun...\nPress Esc to leave the program\nAverage reaction time: {}ms",
        'press_esc': 'Press Esc to leave the program'
    },
    'Kazakh': {
        'welcome': 'Бұл экспериментке қош келдіңіз.\n\nБұл тапсырмада сізге ортасында стрелка орналасқан, айналасында стрелкалар немесе блоктар бар сурет ұсынылады. Орталық стрелка солға немесе оңға бағытталады.\n\nКейде жанындағы стрелкалар орталық стрелкамен бір бағытта болады, ал кейде керісінше бағытта көрсетіледі.\n\nмысалы: >>>>> немесе >><>>\n\nСіздің тапсырмаңыз – орталық стрелканың бағытын көрсету.\n\nЕгер орталық стрелка оңға бағытталса, оң жақтағы стрелка түймесін басыңыз, ал егер солға бағытталса, сол жақтағы стрелка түймесін басыңыз.\n\nЖалғастыру үшін space пернесін басыңыз.',
        'instructions': 'Бұл тапсырмада сіз стрелканың бағытын стрелка пернелері арқылы көрсетуіңіз керек.\nАлдымен экранның ортасында фиксациялық + белгісі пайда болады. Кейде бұл фиксациядан кейін экранда блоктар көрсетіледі, олар мақсатты стимулдың орналасуын көрсетуі мүмкін немесе көрсетпеуі мүмкін.\nЕгер фиксациядан кейін блоктар пайда болса, бұл мақсатты стимул жақын арада пайда болады дегенді білдіреді.\nЕгер блоктар фиксациялық + үстінде НЕМЕСЕ астында пайда болса, мақсатты стимул жақын арада сол көрсетілген жерде пайда болады.\nСол және оң стрелка пернелеріне сұқ саусақтарыңызды қойып дайындалыңыз және жалғастыру үшін spacebar пернесін басыңыз.',
        'reminder': 'Орталық стрелканың бағытын пернетақтадағы сол және оң стрелка пернелері арқылы көрсетіңіз.',
        'correct': "Дұрыс! Сіздің реакция уақытыңыз: ",
        'incorrect': "Қате!",
        'no_response': "Жауап беруді ұмытпаңыз!",
        'end_message': "Сіз {} рет дұрыс жауап бердіңіз, барлығы {}!\nҚызықты болды ма...\nБағдарламадан шығу үшін Esc басыңыз\nОрташа реакция уақыты: {}ms",
        'press_esc': 'Бағдарламадан шығу үшін Esc басыңыз'
    },
    'Russian': {
        'welcome': 'Добро пожаловать в эксперимент.\n\nВ этом задании вам будет представлена центральная стрелка, окруженная другими стрелками или блоками. Центральная стрелка будет указывать влево или вправо.\n\nИногда окружающие стрелки будут указывать в том же направлении, что и центральная стрелка, а иногда - в противоположном направлении.\n\nНапример: >>>>> или >><>>\n\nВаша задача - реагировать на направление центральной стрелки.\n\nЕсли стрелка указывает вправо, нажмите правую клавишу со стрелкой, а если влево - левую клавишу со стрелкой.\n\nНажмите пробел, чтобы продолжить.',
        'instructions': 'В этом задании вы должны реагировать на направление центральной стрелки, используя клавиши со стрелками.\n\nСначала в центре экрана появится фиксационный крест. Иногда после фиксации на экране появляются блоки, которые могут указывать на местоположение целевого стимула. Если блоки появляются после фиксации, это означает, что цель скоро появится.\n\nЕсли блоки появляются НАД или ПОД фиксационным крестом, цель скоро появится в этом месте.\n\nПоложите указательные пальцы на левую и правую клавиши, чтобы быть готовыми, и нажмите пробел, чтобы продолжить.',
        'reminder': 'Реагируйте на направление центральной стрелки, используя левую и правую клавиши на клавиатуре.',
        'correct': "Правильно! Ваше время реакции: ",
        'incorrect': "Неправильно!",
        'no_response': "Не забудьте ответить!",
        'end_message': "Вы правильно ответили на {} из {}!\nБыло интересно...\nНажмите Esc, чтобы выйти из программы\nСреднее время реакции: {}ms",
        'press_esc': 'Нажмите Esc, чтобы выйти из программы'
    }
}
...
expInfo = {
    ...
    'language': ['English', 'Kazakh', 'Russian'],  # Add language selection
}
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\Desktop\\Flanker Test\\attention_network_task_lastrun.py',
...
# Adjustable stimulus size (default: 0.25, can be increased for older adults)
stimulus_size = 0.5  # You can adjust this before the experiment starts
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    inst1textbox = visual.TextBox2(
         win, text=translations[expInfo['language']]['welcome'], placeholder='Type here...', font='Arial',
    ...
    inst1textbox_2 = visual.TextBox2(
         win, text=translations[expInfo['language']]['instructions'], placeholder='Type here...', font='Arial',
         ori=0.0, pos=(0, 0), draggable=False,      letterHeight=0.05,
         size=(1.1, 0.9), borderWidth=2.0,
         color='black', colorSpace='rgb',
         opacity=0.8,
    ...
    image = visual.ImageStim(
        ...
        ori=0, pos=(0, 0), draggable=False, size=(stimulus_size, stimulus_size)
,
    ...
    reminder = visual.TextBox2(
         win, text=translations[expInfo['language']]['reminder'],
    ...
    target = visual.ImageStim(
        ...
        image='default.png', mask=None, anchor='center', 
        ori=1.0, pos=(0, 0), draggable=False, size=(stimulus_size, stimulus_size),
        color=[1,1,1], colorSpace='rgb', opacity=1,
        flipHoriz=False, flipVert=False,
        texRes=128, interpolate=True, depth=-2.0)
    ...
    for thisTrial in trials:
        ...
        # Accumulate reaction time and correctness
        if resp.rt is not None:
            if isinstance(resp.rt, list):  # If it's a list
                total_reaction_time += sum(resp.rt)
                reaction_trial_count += len(resp.rt)
            else:  # If it's a single float
                total_reaction_time += resp.rt
                reaction_trial_count += 1
        ...
        # Run 'Begin Routine' code from fb_code
        # In the feedback routine's Begin Routine code (replace the existing fb_code section)
        msg = translations[expInfo['language']]['incorrect']
        fbcol = 'black'

        if resp.corr:
            if resp.rt is not None:  # Check if response exists
                rt_ms = str(int(resp.rt*1000))
                msg = translations[expInfo['language']]['correct'] + rt_ms + 'ms'
            else:
                msg = translations[expInfo['language']]['correct']  # Just show "Correct" without RT
            correct_count += 1
            fbcol = 'green'
        elif not resp.keys:
            msg = translations[expInfo['language']]['no_response']
    ...
    if reaction_trial_count > 0:
        average_rt = total_reaction_time / reaction_trial_count
    else:
        average_rt = None  # or 0
    ...
    inst1textbox_3.setText(
    translations[expInfo['language']]['end_message'].format(
        str(correct_count),
        str(trials.nTotal),
        str(round(average_rt * 1000,3))
    ))
    ...
    results_data = {
        ...
        'Average_RT_ms': [str(round(average_rt * 1000, 3))]
    }
    ...
    # Save to Excel
    output_filename = f"flanker_results_{expInfo['participant']}.xlsx"
    ...
    while continueRoutine:
        ...
        # Check if the message has been shown; if not, display it
        if not press_esc_displayed:
            # Create and draw the message
            press_esc_text = visual.TextStim(win, text=translations[expInfo['language']]['press_esc'], pos=(0, -0.8), color='black', height=0.05)
            press_esc_text.setAutoDraw(True)
            win.flip()
            press_esc_displayed = True
            # Now wait for the Esc key
            waiting_for_exit = True
            while waiting_for_exit:
                keys = event.getKeys()
                if 'escape' in keys:
                    waiting_for_exit = False
                    # Exit the routine loop
                    continueRoutine = False
                core.wait(0.1)
        # refresh the screen
        if continueRoutine:  # don't flip if this routine is over or we'll get a blank screen
    ...
    # mark experiment as finished and ensure proper closure
    endExperiment(thisExp, win=win)
    thisExp.status = FINISHED  # Force experiment completion
    win.close()
    core.quit()
